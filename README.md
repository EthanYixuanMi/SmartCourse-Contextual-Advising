...
<img src="assets/SmartCourse_arch.png" alt="System Architecture" width="600"/>

<em>Fig. 1. SmartCourse system architecture. Users interact via CLI or Gradio GUI; recommendations are generated by a local LLM. This figure corresponds to Fig. 1 in our <a href="https://arxiv.org/abs/xxxx.xxxxx">paper</a>.</em>
...
<em>Fig. 2. Sample LLM response based on transcript and degree plan. This figure corresponds to Fig. 2 in our <a href="https://arxiv.org/abs/xxxx.xxxxx">paper</a>.</em>
...
<em>Fig. 3. Evaluation metrics (PlanScore, PersonalScore, Lift, Recall) across four context modes. This figure corresponds to Fig. 6 in our <a href="https://arxiv.org/abs/xxxx.xxxxx">paper</a>.</em>
