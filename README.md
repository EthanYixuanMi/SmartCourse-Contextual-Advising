...
<em>Fig. 1. SmartCourse system architecture. Users interact via CLI or Gradio GUI; recommendations are generated by a local LLM. This figure corresponds to Fig. 1 in our <a href="https://arxiv.org/abs/2507.22946v1">paper</a>.</em>
...
<em>Fig. 2. Sample LLM response based on transcript and degree plan. This figure corresponds to Fig. 2 in our <a href="https://arxiv.org/abs/2507.22946v1">paper</a>.</em>
...
We evaluated SmartCourse on 25 representative advising queries across four context conditions, as described in our [paper](https://arxiv.org/abs/2507.22946v1). The table below corresponds to Table I.
...
<em>Fig. 3. Evaluation metrics (PlanScore, PersonalScore, Lift, Recall) across four context modes. This figure corresponds to Fig. 6 in our <a href="https://arxiv.org/abs/2507.22946v1">paper</a>.</em>
